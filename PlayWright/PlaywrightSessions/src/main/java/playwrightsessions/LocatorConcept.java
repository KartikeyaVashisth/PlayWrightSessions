...
public class LocatorConcept {
	...
	public static void main(String[] args) {
		...
		List<String> optionsTextList = countryOptions.allTextContents(); //To get the content of all the items and storing in the list
		...
		optionsTextList.forEach(ele -> System.out.println(ele)); //ele represents each and every element of the optionsTextList and passing it through Lambda function to print.
	}
}
